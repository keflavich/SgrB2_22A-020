...
maps_this_session = 10    # let the operator / observer quit at the end of time (10>>length of session, but the ASTRID validator runs each loop so 1000 is a bad idea)
